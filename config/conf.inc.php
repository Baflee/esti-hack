...
//Definition du chemin d'accès aux images
define('REP_DOCUMENTS',URL_ROOT.'/public/Documents');
//Chemin d'accès aux avatars
define('REP_AVATARS',URL_ROOT.'/public/images/avatars');
